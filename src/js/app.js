(function(window){
	...
	var NeighborhoodMap = function(){
		...
		function googleError() {
			...
			// Set errorMessage as html to the div with class
			// message
			...
			// Set apiError to false to toggle visibility
			// of binded html element to false
			apiError(false);
		}
		...
		function getPlaces(callback){
			...
			// Handler to be called when the request is done
			request.done(function(response){
				// Call callback with response as argument
				callback(response);
			});

			// Handler to be called when the request is rejected
	...
	window.NeighborhoodMap = NeighborhoodMap;
